...
Contributions are welcome. `go-ruby-scanf/scanf` is built to a small set of non-negotiable
...
The library is in
[`github.com/go-ruby-scanf/scanf`](https://github.com/go-ruby-scanf/scanf). This documentation site is in
[`github.com/go-ruby-scanf/docs`](https://github.com/go-ruby-scanf/docs). Start from the
